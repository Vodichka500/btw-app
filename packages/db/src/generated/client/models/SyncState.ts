...
export type SyncStateWhereInput = {
  ...
  type?: Prisma.StringFilter<"SyncState"> | string
  syncedAt?: Prisma.DateTimeFilter<"SyncState"> | Date | string
}
...
export type SyncStateScalarWhereWithAggregatesInput = {
  ...
  type?: Prisma.StringWithAggregatesFilter<"SyncState"> | string
  syncedAt?: Prisma.DateTimeWithAggregatesFilter<"SyncState"> | Date | string
}
...
export type SyncStateOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"type" | "syncedAt", ExtArgs["result"]["syncState"]>
...
export interface SyncStateDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const syncStateWithTypeOnly = await prisma.syncState.findMany({ select: { type: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many SyncStates and only return the `type`
   * const syncStateWithTypeOnly = await prisma.syncState.createManyAndReturn({
   *   select: { type: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more SyncStates and only return the `type`
   * const syncStateWithTypeOnly = await prisma.syncState.updateManyAndReturn({
   *   select: { type: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface SyncStateFieldRefs {
  readonly type: Prisma.FieldRef<"SyncState", 'String'>
  readonly syncedAt: Prisma.FieldRef<"SyncState", 'DateTime'>
}
