      ...
      <div className="flex flex-col h-full justify-start">
        <span
          className={cn(
            ...
            isMuted ? 'text-slate-700' : 'text-rose-900',
        ...
        {totalMinutes > 30 && (
          <span
            className={cn(
              ...
              isMuted ? 'text-slate-600' : 'text-rose-700'
            )}
          >
            {lesson.student}
          </span>
        ...
        {totalMinutes >= 45 && (
          <span
            className={cn(
              'text-[9px] font-bold mt-auto pt-0.5 truncate',
              isMuted ? 'text-slate-600' : 'text-rose-600'
            )}
          >
            {lesson.timeFrom} - {lesson.timeTo}
          </span>
